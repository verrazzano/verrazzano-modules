...
var componentShimDelegates = map[string]func(*modulesv1alpha1.ModuleLifecycle, client.StatusWriter) delegates.DelegateLifecycleReconciler{
...
func New(mlc *modulesv1alpha1.ModuleLifecycle, sw client.StatusWriter) (delegates.DelegateLifecycleReconciler, error) {
...
func newShimDelegate(mlc *modulesv1alpha1.ModuleLifecycle, sw client.StatusWriter) delegates.DelegateLifecycleReconciler {
