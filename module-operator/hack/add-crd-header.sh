...
GENERATED_CRDS_DIR=$SCRIPT_DIR/../config/crd/bases
...
go run ../tools/fix-copyright/copyright.go -useExistingUpdateYearFromHeader $GENERATED_CRDS_DIR

# Then fix the updated year for files that were modified this year
go run ../tools/fix-copyright/copyright.go $GENERATED_CRDS_DIR
