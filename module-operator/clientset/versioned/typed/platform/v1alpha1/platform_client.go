...
import (
	...
	"github.com/verrazzano/verrazzano-modules/module-operator/clientset/versioned/scheme"
...
func (c *PlatformV1alpha1Client) ModuleLifecycles(namespace string) ModuleLifecycleInterface {
