...
type helmComponentAdapter struct {
	...
	module *modulesv1alpha1.ModuleLifecycle
}
...
func newHelmAdapter(mlc *modulesv1alpha1.ModuleLifecycle, sw client.StatusWriter) delegates.DelegateLifecycleReconciler {
