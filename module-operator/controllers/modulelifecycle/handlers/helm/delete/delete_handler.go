...
func (h HelmHandler) DoAction(context handlerspi.HandlerContext) (ctrl.Result, error) {
...
func (h HelmHandler) IsActionDone(context handlerspi.HandlerContext) (bool, ctrl.Result, error) {
	if context.DryRun {
