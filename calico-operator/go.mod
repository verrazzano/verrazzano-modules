...
require (
	...
	github.com/verrazzano/verrazzano-modules/common v0.0.0-20230414232440-a3e9a4665948
...
require (
	...
	github.com/verrazzano/verrazzano v0.17.1-0.20230414201321-73f1a8f85d15 // indirect
