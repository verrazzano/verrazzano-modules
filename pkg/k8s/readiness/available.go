...
// ModuleAvailability identifies the availability of a Module.
type ModuleAvailability string

const (
	//ModuleAvailable signifies that a Module is ready for use.
	ModuleAvailable = "Available"
	//ModuleUnavailable signifies that a Module is not ready for use.
...
func (c *AvailabilityObjects) IsAvailable(log vzlog.VerrazzanoLogger, client clipkg.Client) (string, ModuleAvailability) {
...
func handleNotAvailableError(log vzlog.VerrazzanoLogger, err error) (string, ModuleAvailability) {
